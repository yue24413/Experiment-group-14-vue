...
import service1 from '@/assets/img/k1.jpg'
import service2 from '@/assets/img/k2.jpg'
import service3 from '@/assets/img/k3.jpg'
import service4 from '@/assets/img/k4.jpg'
import service5 from '@/assets/img/k5.jpg'
...
<template>
  <div id="Service">
   <div class="container text-center" style="display: flex;justify-content: center;" >
      <h3 style="margin: auto;font-size: larger;">特摄剧介绍</h3>
    </div>
    <div class="container">
      <div class="Service-container row" style="width: 100%;">
        <div
          class="Service-item col-xs-12 col-sm-6 col-md-4  wow slideInUp"
